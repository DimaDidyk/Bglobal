...
var ClientInfoComponent = /** @class */ (function () {
    function ClientInfoComponent(route, router) {
        this.route = route;
        this.router = router;
        this.emailPattern = "[^ @]*@[^ @]*";
...
var FlyFormComponent = /** @class */ (function () {
    function FlyFormComponent(//private http: HttpClient,
        route, adapter, picker, httpService) {
        this.route = route;
        ...
        this.countries = [];
        // SimPackages
        this.simPackages = new __WEBPACK_IMPORTED_MODULE_3__entity_package__["b" /* SimPackages */]();
...
var OffersComponent = /** @class */ (function () {
    ...
    OffersComponent.prototype.getSlideData = function (rout) {
        return this.sliderItems.find(function (sliderItems) { return sliderItems.rout == rout; });
    };
    OffersComponent.prototype.replaceSpace = function (str) {
        str = str.replace(/ /ig, '-');
        return str;
    };
    OffersComponent.prototype.routPackage = function (packageName) {
        var _this = this;
