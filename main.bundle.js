...
var FlyFormComponent = /** @class */ (function () {
    ...
    FlyFormComponent.prototype.clickPick = function () {
        console.log('this');
        var classname = document.getElementsByClassName('mat-calendar-body-today');
