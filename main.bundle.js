...
var routes = [
    ...
    { path: 'user/info', component: __WEBPACK_IMPORTED_MODULE_12__info_page_info_page_component__["b" /* InfoPageComponent */] },
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_37__info_page_info_page_component__["b" /* InfoPageComponent */],
                __WEBPACK_IMPORTED_MODULE_37__info_page_info_page_component__["a" /* DialogUpdateInfo */],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return InfoPageComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DialogUpdateInfo; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_material___ = __webpack_require__("./node_modules/@angular/material/esm5/material.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var InfoPageComponent = /** @class */ (function () {
    ...
    InfoPageComponent.prototype.openDialog = function () {
...
// Update info dialog
var DialogUpdateInfo = /** @class */ (function () {
    function DialogUpdateInfo(dialogRef) {
        this.dialogRef = dialogRef;
        // validation
        this.emailPattern = "[^ @]*@[^ @]*";
    }
    DialogUpdateInfo.prototype.numberTel_keyPress = function (event) {
        var pattern = /[0-9/+/ /(/)/]/;
        var inputChar = String.fromCharCode(event.charCode);
        if (!pattern.test(inputChar)) {
            // invalid character, prevent input
    ...
    DialogUpdateInfo.prototype.closeDialog = function () {
        this.dialogRef.close();
    };
    // submit Sign in form
    DialogUpdateInfo.prototype.onSubmit = function (updateInfoForm) {
        console.log(updateInfoForm.value);
        this.closeDialog();
    };
    DialogUpdateInfo = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'dialog-update-info',
            template: __webpack_require__("./src/app/info-page/dialog-update-info.html"),
            styles: [__webpack_require__("./src/app/info-page/dialog-update-info.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_material___["f" /* MatDialogRef */]])
    ], DialogUpdateInfo);
