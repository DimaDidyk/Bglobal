    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3__angular_material__["d" /* MatDatepickerModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_3__angular_material__["n" /* MatRadioModule */],
...
var ClientInfoComponent = /** @class */ (function () {
    function ClientInfoComponent(route, router, httpService) {
        this.route = route;
        this.router = router;
        this.httpService = httpService;
        this.emailPattern = "[^ @]*@[^ @]*";
    ...
    ClientInfoComponent.prototype.onSubmit = function (clientInfoForm) {
        ...
        this.httpService.postDataRegister(this.userDataRegister)
            .subscribe(function (error) { return console.log(error); }, function (data) { return console.log(data); });
    };
    // scroll animate
...
var DeliveryComponent = /** @class */ (function () {
    ...
    DeliveryComponent.prototype.handleAddressChange = function (address) {
        ...
        if (!locality)
            this.errorLocality += 'Введите название города\n';
        if (!route)
            this.errorLocality += 'Введите название улицы\n';
        if (!street_number)
...
/* unused harmony export ClosestPickUpPoints */
...
var HeaderComponent = /** @class */ (function () {
    ...
    // open sign in dialog
    HeaderComponent.prototype.openDialogMessage = function () {
...
var DialogMessage = /** @class */ (function () {
    function DialogMessage(dialogRef) {
        this.dialogRef = dialogRef;
    }
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.getDataCoupon = function (code) {
        return this.http.get(this.baseUrl + "Payment/GetCouponValue" + code, httpOptions);
    };
    // postDataCoupon(coupone: Coupon){
    //     const body = {
    //         Code: coupone.Code,
    //         // Currency: coupone.Currency,
    //     };
...
var TotalComponent = /** @class */ (function () {
    ...
    TotalComponent.prototype.getConfigCoupone = function (code) {
        return this.httpService.getDataCoupon(code);
    };
    TotalComponent.prototype.sendCoupon = function (coupon) {
        var _this = this;
        // data to send
        this.coupon.Code = '?Code=M30000';
        console.log(this.coupon);
        this.getConfigCoupone(this.coupon.Code).subscribe(function (data) { return _this.coupon; });
        console.log(this.coupon);
